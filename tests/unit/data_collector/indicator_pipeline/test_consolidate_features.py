...
def test_main_returns_none_when_no_available_tickers():
    ...
    fake_storage.get_storage_stats.return_value = {"total_size_mb": 0.0, "base_path": "features"}
...
def test_main_success_with_sampling_and_consolidation():
    ...
    fake_storage.get_storage_stats.return_value = {"total_size_mb": 123.45, "base_path": "features"}
    ...
    fake_result = {
        ...
        "files": [
            {"file": "features/2021.parquet", "rows": 6000, "size_mb": 30.0, "year": 2021},
            {"file": "features/2022.parquet", "rows": 4000, "size_mb": 20.0, "year": 2022},
        ],
    }
...
def test_main_handles_consolidation_exception_and_returns_none():
    ...
    fake_storage.get_storage_stats.return_value = {"total_size_mb": 10.0, "base_path": "features"}
    # For sampling path
    ...
    with (
        patch.object(mod, "FeatureStorage", return_value=fake_storage),
        patch.object(mod, "consolidate_existing_features", side_effect=RuntimeError("boom")),
    ):

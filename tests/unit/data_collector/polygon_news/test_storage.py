...
def test_store_article_create_and_update_flow(mocker, sample_raw_article_full):
    ...
    mocker.patch("src.data_collector.polygon_news.storage.run_in_transaction", return_value=1)
...
@pytest.mark.unit
def test_store_articles_batch_mixed(mocker, sample_raw_article_full, sample_raw_article_missing):
    ...
    mocker.patch.object(storage, "_create_new_article", side_effect=_create_new_article_side)

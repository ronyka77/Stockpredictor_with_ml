...
class FeatureCategoryConfig:
    ...
    AVAILABLE_MARKETS: List[str] = field(
        default_factory=lambda: ["stocks", "crypto", "forex", "all"]
    )
...
class FundamentalConfig:
    ...
    PE_RATIO_CAP: Tuple[float, float] = field(
        default_factory=lambda: _parse_tuple_float("FE_PE_RATIO_CAP", (-100, 100))
    )
    PB_RATIO_CAP: Tuple[float, float] = field(
        default_factory=lambda: _parse_tuple_float("FE_PB_RATIO_CAP", (0, 50))
    )
    DEBT_TO_EQUITY_CAP: Tuple[float, float] = field(
        default_factory=lambda: _parse_tuple_float("FE_DEBT_TO_EQUITY_CAP", (0, 10))
    )
    CURRENT_RATIO_CAP: Tuple[float, float] = field(
        default_factory=lambda: _parse_tuple_float("FE_CURRENT_RATIO_CAP", (0, 20))
    )
    ROE_CAP: Tuple[float, float] = field(
        default_factory=lambda: _parse_tuple_float("FE_ROE_CAP", (-1, 2))
    )
    ROA_CAP: Tuple[float, float] = field(
        default_factory=lambda: _parse_tuple_float("FE_ROA_CAP", (-1, 1))
    )
    NET_MARGIN_CAP: Tuple[float, float] = field(
        default_factory=lambda: _parse_tuple_float("FE_NET_MARGIN_CAP", (-2, 2))
    )
    GROSS_MARGIN_CAP: Tuple[float, float] = field(
        default_factory=lambda: _parse_tuple_float("FE_GROSS_MARGIN_CAP", (-1, 1))
    )
    OPERATING_MARGIN_CAP: Tuple[float, float] = field(
        default_factory=lambda: _parse_tuple_float("FE_OPERATING_MARGIN_CAP", (-2, 2))
    )
    ASSET_TURNOVER_CAP: Tuple[float, float] = field(
        default_factory=lambda: _parse_tuple_float("FE_ASSET_TURNOVER_CAP", (0, 10))
    )
    QUICK_RATIO_CAP: Tuple[float, float] = field(
        default_factory=lambda: _parse_tuple_float("FE_QUICK_RATIO_CAP", (0, 20))
    )
    CASH_RATIO_CAP: Tuple[float, float] = field(
    ...
    SIC_ENERGY_RANGE: Tuple[int, int] = field(
        default_factory=lambda: _parse_tuple_int("FE_SIC_ENERGY_RANGE", (100, 999))
    )
    SIC_MATERIALS_RANGE: Tuple[int, int] = field(
    ...
    GROWTH_PERIODS: List[int] = field(
        default_factory=lambda: _parse_list_int("FE_GROWTH_PERIODS", [1, 3, 5])
    )

...
class TestMLPScalerImplementation:
    ...
    def test_validate_and_clean_data_method(self):
        ...
        X_clean, scaler = MLPDataUtils.validate_and_clean_data(
            data=self.X_test,
            scaler=None,
            fit_scaler=True
        )
        ...
        X_clean2, _ = MLPDataUtils.validate_and_clean_data(
            data=self.X_test,
            scaler=scaler,
            fit_scaler=False
        )
    ...
    def test_confidence_calculation_with_scaler(self):
        ...
        confidence = self.predictor.get_prediction_confidence(self.X_test, method='variance')

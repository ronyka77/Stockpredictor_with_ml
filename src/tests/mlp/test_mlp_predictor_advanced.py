...
def test_model_checkpointing():
    ...
    checkpoint_path = os.path.join(checkpoint_dir, f"{predictor.model_name}_checkpoint.pth")
...
if __name__ == "__main__":
    print("Running MLP Predictor Advanced Features Tests...")
    print("=" * 60)
    ...
    try:
        ...
        print("\n" + "=" * 60)
        print("🎉 All advanced MLP predictor tests passed!")

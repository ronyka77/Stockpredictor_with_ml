...
class PolygonFundamentalsClient:
    ...
    def _extract_financial_value(
        data: Any, field_name: str, statement_type: str
    ...
    def _parse_direct_list_format(
        self, data: Dict[str, Any], ticker: str, response: FundamentalDataResponse
    ) -> FundamentalDataResponse:
        ...
        try:
            ...
            logger.info(
                f"Parsed direct format: {len(response.income_statements)} income statements, "
    ...
    def _parse_income_statement_direct(
        ...
        try:
            ...
            for field in financial_fields:
                financial_value = self._extract_financial_value(
                    stmt_data, field, "income_statement"
                )
    ...
    def _parse_cash_flow_statement_direct(
        self, stmt_data: Dict[str, Any]
        ...
        try:
            ...
            financial_fields = [
                ...
                "increase_decrease_in_other_operating_assets_liabilities",
                "net_cash_flow_from_investing_activities",
                "payments_to_acquire_property_plant_and_equipment",
                "payments_to_acquire_businesses_net_of_cash_acquired",
            ...
            for field in financial_fields:
                financial_value = self._extract_financial_value(
                    stmt_data, field, "cash_flow_statement"
                )
                if financial_value is not None:
                    parsed_data[field] = financial_value

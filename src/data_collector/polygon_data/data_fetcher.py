...
class HistoricalDataFetcher:
    ...
    def get_bulk_historical_data(
        ...
        validate_data: bool = True,
    ) -> Dict[str, tuple[List[OHLCVRecord], DataQualityMetrics]]:
        """
        ...
        for batch_num in range(total_batches):
            ...
            for ticker in batch_tickers:
                try:
                    ...
                    logger.info(
                        f"Completed {ticker}: {len(records)} records, "
    ...
    def get_grouped_daily_data(
        self, target_date: Union[str, date], validate_data: bool = True
    ) -> Dict[str, OHLCVRecord]:
        """
    ...
    def _transform_polygon_record(
        self, polygon_record: Dict[str, Any], ticker: str

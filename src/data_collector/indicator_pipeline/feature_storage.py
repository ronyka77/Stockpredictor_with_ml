...
class FeatureStorage:
    ...
    def load_features(
    ...
    ) -> Tuple[pd.DataFrame, Optional[FeatureMetadata]]:
        """
        ...
        try:
            ...
            if categories:
                ...
                category_columns = filter_columns_by_categories(
                    list(features_data.columns), categories
                )
    ...
    def _load_metadata_from_parquet(
